      ...
      >
        {modalCardData && (
          <div>
            ...
            <p><strong>Static Card Position:</strong> {cardData[modalCardData.staticData.value2]?.position}</p>
            <p><strong>Static Keywords:</strong> {cardData[modalCardData.staticData.value2]?.keywords}</p>
            <p><strong>Static Dates:</strong> {cardData[modalCardData.staticData.value2]?.dates}</p>
            <h3>Static Card Position: {modalCardData.staticData.value1}</h3>
            <p><strong>Static Card Position:</strong> {cardData[modalCardData.staticData.value1]?.position}</p>
            <p><strong>Static Keywords:</strong> {cardData[modalCardData.staticData.value1]?.keywords}</p>
            <p><strong>Static Dates:</strong> {cardData[modalCardData.staticData.value1]?.dates}</p>
